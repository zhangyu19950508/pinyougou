						...
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									...
									<li><img src="${item.url}" bimg="${item.url}" onmousemove="preview(this)" height="400px" width="400px"/></li>
									</#list>
								</ul>
							</div>
							<a class="next">&gt;</a>
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as specification>
								<dl>
									<dt>
										<div class="fl title">
											<i>选择${specification.name}</i>
										</div>

									</dt>
									<dd>
										<a  class="{{isSelected('${specification.name}','${item}')?'selected':''}}"
											ng-click="selectSpecification('${specification.name}','${item}')">
											${item}
											<span title="点击取消选择">&nbsp;</span>
										</a>
									</dd>

									<#list specification.values as item>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a  target="_blank" click="addToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
